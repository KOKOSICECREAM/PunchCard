...
| Tests | 80 passing, including 5 invariants over ~16,000 randomised calls + 1 fork test against Base mainnet — pricing maths, fee-split invariants, drawer/emission/pause, against mocks |
